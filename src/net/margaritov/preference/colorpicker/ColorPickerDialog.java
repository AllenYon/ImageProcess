...
import com.example.BitmapEffect.MainActivity;
...
public class ColorPickerDialog
    ...
    private OnPaintChangedListener mPaintListener;

    // Custom
    private PrePaintView mPrePaintView;
...
//    private Button mBtnCancel, mBtnOk;
    ...
    private void setUp(int color) {
        ...
        //Custom
        mPrePaintView = (PrePaintView) layout.findViewById(R.id.prepaint_view);
        mPrePaintView.setOnClickListener(this);
...
//        mBtnOk = (Button) layout.findViewById(R.id.btn_ok);
        ...
        mSeekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                //ToDo
                mPrePaintView.setStrokeWidth(progress);
            }
    ...
    public void onColorChanged(int color) {
		...
		*/
        ...
        //Custom
        if (mPrePaintView != null) {
            mPrePaintView.setPreColor(color);
        }
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.prepaint_view) {
            if (mPaintListener != null) {
                mPaintListener.onPaintChanged(mPrePaintView.mColor, mPrePaintView.mStrokeWidth);
            }
        }
        dismiss();
    }
